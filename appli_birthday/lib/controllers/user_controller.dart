...
class UserController {
  ...
  static Future<User> getUser(String userName, String password) async {
    ...
    User user = User(id: responseMap['id'], firstName: responseMap['firstname'], lastName: responseMap['lastname'], email: responseMap['email'], role: 0);

    return user;
  }

  static Future<void> deleteUser(int userId) async {
    var response = await AppliAPI.get(
      '/user/$userId/delete'
    );
