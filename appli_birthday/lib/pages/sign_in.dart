...
import 'package:appli_birthday/controllers/user_controller.dart';
...
class SignInPageState extends State<SignInPage> {
  ...
  void login() {
    AuthController.login(user.email, user.password)
      .then((success) async {
        if (success) {
          User userLogged =
      ...
      .catchError((err) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Connexion échouée, verifiez vos identifiants')),
        );
      });
  }
