...
import 'package:appli_birthday/models/user.dart';
...
class RegisterPageState extends State<RegisterPage> {
  ...
  User user = User(id: 0, firstName: "", lastName: "", email: "", password: "", role: 0);
  ...
  void signin() {
    AuthController.signin(user.firstName, user.lastName, user.email, user.password)
      .then((success) async {
        if (success) {
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                if (user.password != confirmPassword) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('Votre mot de passe et sa confirmation ne correspondent pas')),
                                  );
                                } else {
                                  signin();
                                  Navigator.pushNamed(context, '/sign-in');
