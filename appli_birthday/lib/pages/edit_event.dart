                                                  ...
                                                  child: Row(children: [
                                                    Flexible(
                                                      ...
                                                      decoration:
                                                        ...
                                                        suffixIcon: IconButton(
                                                          onPressed: () {
                                                            if (hasGiftIdeaChanged == false) {
                                                              giftIdeaList.firstWhere((x) => x.id == editId).name = giftIdeaList[index].name;
                                                            } else {
                                                              giftIdeaList.firstWhere((x) => x.id == editId).name = giftIdea.name;
                                                            }
                                                        ...
                                                        hintText: giftIdeaList[index].name,
                                                        hintStyle:
                                                            const TextStyle(
                                                                color: Color
                                                                    .fromARGB(
                                      ...
                                      child: const Text('Valider',
                                          style: TextStyle(
                                              ...
                                              color: Color.fromARGB(
                                                  255, 0, 0, 0))),
                                      onPressed: () {
                                        snapshot.data!.giftList = giftIdeaList;
                                        ...
                                        if (hasGiftIdeaListChanged) {
                                          updatedEvent.giftList = giftIdeaList;
                                        }
                                        EventController.editEvent(widget.eventId, updatedEvent);
